...
@section('content')
<div class="row">
    <form method="POST"  action="{{ route('admin.recursos_digitales.update', $recursoDigital->id) }}"
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{$errors->has('titulo') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="titulo" placeholder="Ingresa aqui el titulo del recurso digital"
                            class="form-control" value="{{$recursoDigital->titulo}}">
                    ...
                    <div class="form-group {{$errors->has('categoria') ? 'has-error' : '' }}">
                        ...
                        <select name="categoria" id="" class="form-control">
                            ...
                            @if($categoria->id ==$recursoDigital->categoria_id)
                    ...
                    <div class="form-group {{$errors->has('descripcion') ? 'has-error' : '' }}">
                        ...
                        <textarea rows="3" name="descripcion" class="form-control"
                            placeholder="Ingresa descripcion del recurso digital">{{$recursoDigital->descripcion}}</textarea>
                    ...
                    <div class="form-group {{$errors->has('archivo') ? 'has-error' : '' }}">
                        <label>Archivo</label>
                    <input type="file" name="archivo" class="form-control" src="{{$recursoDigital->archivo}}"
